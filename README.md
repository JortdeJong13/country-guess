...
For your convenience, I have deployed the Country Guess App, and it is accessible at [country-guess.nl](https://country-guess.nl).
Alternatively, you can follow the instructions to run the app locally or using Docker.
